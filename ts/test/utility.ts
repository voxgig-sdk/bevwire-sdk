...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BEVWIRE_TEST_LIVE ||
    'TRUE' === process.env.BEVWIRE_TEST_OVERRIDE
  ) {
  ...
  m.BEVWIRE_TEST_EXPLAIN = process.env.BEVWIRE_TEST_EXPLAIN || m.BEVWIRE_TEST_EXPLAIN
