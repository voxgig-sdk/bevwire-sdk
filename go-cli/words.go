...
func registerSDKWords(r *eng.Registry, client *sdk.BevwireSDK) {
...
func runOp(client *sdk.BevwireSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
