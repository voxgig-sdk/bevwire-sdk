# Bevwire SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BevwireSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BevwireSDK(...) and BevwireSDK.test(...) become
#      BevwireSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bevwire_sdk"
_SDK_CLASS = "BevwireSDK"
