...
The Python SDK for the Bevwire API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/bevwire-sdk/releases)) or
...
```
py/
├── bevwire_sdk.py         -- Main SDK module
