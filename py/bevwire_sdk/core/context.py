...
from bevwire_sdk.core.control import BevwireControl
...
from bevwire_sdk.core.helpers import get_ctx_prop, to_map
...
class BevwireContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, BevwireResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BevwireError(code, msg, self)
