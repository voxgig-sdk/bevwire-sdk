...
from bevwire_sdk.utility import register

# Load features
from bevwire_sdk.feature.base_feature import BevwireBaseFeature
from bevwire_sdk.features import _make_feature
...
class BevwireSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BevwireUtility()
        self._utility = utility

        from bevwire_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return BevwireUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BevwireSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Article(self, data=None) -> "ArticleEntity":
        ...
        from bevwire_sdk.entity.article_entity import ArticleEntity
    ...
    def Company(self, data=None) -> "CompanyEntity":
        ...
        from bevwire_sdk.entity.company_entity import CompanyEntity
        return CompanyEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BevwireSDK":
        if sdkopts is None:
            sdkopts = {}
