...
class BevwireGraphql
{
    ...
    // equivalent.
    public static function body(BevwireContext $ctx): mixed
    {
    ...
    public static function errors(BevwireContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
