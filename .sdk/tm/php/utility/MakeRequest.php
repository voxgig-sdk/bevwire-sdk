...
// Bevwire SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BevwireMakeRequest
{
    public static function call(BevwireContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BevwireResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BevwireResponse($fetched);
        } else {
