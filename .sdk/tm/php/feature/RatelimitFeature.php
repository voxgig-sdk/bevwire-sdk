...
class BevwireRatelimitFeature extends BevwireBaseFeature
{
    ...
    private function _acquire(BevwireContext $ctx): void
    {
    ...
    private function _track(BevwireContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
