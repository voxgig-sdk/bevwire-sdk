...
class BevwireRbacFeature extends BevwireBaseFeature
{
    ...
    private function _required(BevwireContext $ctx): ?string
    {
    ...
    private function _reject(BevwireContext $ctx, string $required): void
    {
    ...
    private function _track(BevwireContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
