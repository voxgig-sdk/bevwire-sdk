...
class BevwireCacheFeature extends BevwireBaseFeature
{
    ...
    private function _through(BevwireContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
