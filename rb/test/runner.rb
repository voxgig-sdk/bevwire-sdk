...
module BevwireTestRunner
  ...
  def self.env_override(m)
    live = getenv("BEVWIRE_TEST_LIVE")
    override = getenv("BEVWIRE_TEST_OVERRIDE")
    ...
    explain = getenv("BEVWIRE_TEST_EXPLAIN")
    m["BEVWIRE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BevwireTestRunner
Helpers = BevwireHelpers
Vs = VoxgigStruct
