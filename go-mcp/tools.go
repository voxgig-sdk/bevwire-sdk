...
type Args struct {
	Entity string         `json:"entity" jsonschema:"article | company"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BevwireSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bevwire_list",
		Description: "List records from Bevwire. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bevwire_load",
		Description: "Load a single record from Bevwire. " +
...
func runOp(client *sdk.BevwireSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BevwireSDK, name string) (sdk.BevwireEntity, error) {
