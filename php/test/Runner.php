...
class BevwireTestRunner
{
    ...
    {
        $live = self::getenv('BEVWIRE_TEST_LIVE');
        $override = self::getenv('BEVWIRE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BEVWIRE_TEST_EXPLAIN');
...
class_alias('BevwireTestRunner', 'Runner');
class_alias('BevwireHelpers', 'Helpers');
