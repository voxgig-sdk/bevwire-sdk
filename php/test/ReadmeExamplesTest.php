...
// Bevwire SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BevwireSDK::test)
...
{
    private const SDK_CLASS = 'BevwireSDK';
    ...
    private const SDK_BASE = 'bevwire_sdk';
