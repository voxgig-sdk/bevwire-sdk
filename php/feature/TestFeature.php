...
// Bevwire SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BevwireTestFeature extends BevwireBaseFeature
{
    ...
    public function init(BevwireContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BevwireContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BevwireContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BevwireContext $ctx, $op, $args): array
    {
