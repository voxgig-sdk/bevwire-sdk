...
class BevwireProxyFeature extends BevwireBaseFeature
{
    ...
    public function init(BevwireContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BevwireContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
