...
class BevwireTimeoutFeature extends BevwireBaseFeature
{
    ...
    private function _with_timeout(BevwireContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BevwireContext $_ctx, float $ms): void
    {
        $client = $this->client;
