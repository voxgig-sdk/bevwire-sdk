...
class BevwireStreamingFeature extends BevwireBaseFeature
{
    ...
    private function _iterate(BevwireResult $result): \Generator
    {
    ...
    private function _streamable(BevwireContext $ctx): bool
    {
