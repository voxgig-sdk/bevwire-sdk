...
// Bevwire SDK clienttrack feature
...
class BevwireClienttrackFeature extends BevwireBaseFeature
{
    ...
    public function PostConstruct(BevwireContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Bevwire-SDK';
