...
// Bevwire SDK utility: fetcher

class BevwireFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BevwireSDK/1.0)';
    ...
    public static function call(BevwireContext $ctx, string $fullurl, array $fetchdef): array
    {
