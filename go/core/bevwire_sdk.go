...
import (
	...
	vs "github.com/voxgig-sdk/bevwire-sdk/go/utility/struct"
)

type BevwireSDK struct {
	Mode     string
...
func (sdk *BevwireSDK) OptionsMap() map[string]any {
...
func (sdk *BevwireSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BevwireSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BevwireSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BevwireSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BevwireSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BevwireSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BevwireSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BevwireSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BevwireSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BevwireSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *BevwireSDK) Article(data map[string]any) BevwireEntity {
...
func (sdk *BevwireSDK) Company(data map[string]any) BevwireEntity {
